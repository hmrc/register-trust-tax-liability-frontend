...
class TaxLiabilityNavigator @Inject() () extends Navigator {
  ...
  override def nextPage(page: Page, draftId: String, userAnswers: UserAnswers): Call =
  ...
  private def conditionalNavigation(draftId: String): PartialFunction[Page, UserAnswers => Call] = {
    case CYMinusFourYesNoPage  =>
      ua =>
        yesNoNav(
          ua,
          CYMinusFourYesNoPage,
    ...
    case CYMinusThreeYesNoPage =>
      ua =>
        yesNoNav(
          ua,
          CYMinusThreeYesNoPage,
