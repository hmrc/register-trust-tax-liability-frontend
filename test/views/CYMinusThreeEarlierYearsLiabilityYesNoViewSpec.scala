...
class CYMinusThreeEarlierYearsLiabilityYesNoViewSpec extends YesNoViewBehaviours {

  val messageKeyPrefix = "cyMinusThree.earlierYearsLiability"
  val taxYear = "2000"

  val form: Form[Boolean] = new YesNoFormProvider().withPrefix(messageKeyPrefix)

  "CYMinusThreeEarlierYearsLiabilityYesNo view" must {

    val view = viewFor[CYMinusThreeEarlierYearsYesNoView](Some(emptyUserAnswers))
